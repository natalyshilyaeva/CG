...
namespace CGLabPlatform
{
    ...
    public class DMatrix6Edit : NumericUpDownTable<DMatrix6> {
        public DMatrix6Edit() : base(6, 6) { }

        protected override DMatrix6 ElementValueChanged(DMatrix6 value) {
            return new DMatrix6(ReadValues(value.ToDecimalArray()));
        }
