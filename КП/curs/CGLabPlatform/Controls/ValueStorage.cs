...
//_Layout.Controls.Add(new ColorPickerBox(), 0, _Layout.RowCount);
...
//_Layout.RowCount++;
            ...
            //_Panel.Height = _Layout.RowStyles _RowHeight * _Layout.RowCount + _Layout.Padding.Vertical;
            _Layout.RowCount++;
            LayoutUpdated = true;
    ...
    public abstract class DisplayPropertyAttribute : Attribute
    {
        ...
        internal protected enum DisplayType { Unknown, Checker, Numeric, TextBox, EnumList, Vector2, Vector3, Vector4, Matrix3, Matrix4, Matrix6, ColorBox }
    ...
    public sealed class DisplayNumericPropertyAttribute : DisplayPropertyAttribute {
        ...
        private DisplayNumericPropertyAttribute(object Default, string Name, dynamic Increment, dynamic Minimum,
            ...
            switch (displayType) {
                ...
                case DisplayType.Matrix6: values = ((DMatrix6)this.Default).ToArray().Select(v => (decimal)v); break;
        ...
        public override double LineHeightFactor { get {
            switch (displayType) {
                ...
                case DisplayType.Matrix6: return 6 * base.LineHeightFactor;
        ...
        private static DisplayType GetDisplayType(object Default)
        {
            ...
            if (type.IsArray && type.GetArrayRank() == 1) {
                switch ((Default as Array).Length) {
                    ...
                    case 36: return DisplayType.Matrix6;
                }
            }
        ...
        private static object ConvertTo(object Default)
        {
            ...
            if (type.IsArray && type.GetArrayRank() == 1) {
                ...
                switch (array.Length) {
                    ...
                    case 36: return new DMatrix6(array);
                    default: return null;
                }
            }
        ...
        protected override Control CreateControl() {
            switch (displayType) {
                ...
                case DisplayType.Matrix6: return new DMatrix6Edit()    { Minimum = Minimum, Maximum = Maximum, Increment = Increment, DecimalPlaces = Decimals };
                default: throw new NotSupportedException();
            }
        }
    ...
    public sealed class DisplayColorBoxPropertyAttribute : DisplayPropertyAttribute { 
        ...
        protected override Control CreateControl()
        {
            return null;// new ColorPickerBox(); //{ AutoSize = true, Text = Name };
        }
    }
}
